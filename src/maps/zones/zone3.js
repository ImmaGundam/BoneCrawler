...
(function(){
  ...
  const scene = {
    ...
    objects:[
      GameObjectFactory.create('bookshelf',{id:'zone3.bookshelf0',label:'Zone 3 Bookshelf 1',breakRect:r(PX+2,PY+22,6,17),blockRect:r(PX+2,PY+22,6,17),render:{sprite:'bookshelf',x:PX+2,y:PY+22,variant:0,layer:'main',overlayRect:r(PX+2,PY+22,6,11)},broken:{sprite:'rubble',x:PX+5,y:PY+39,variant:0}}),
      GameObjectFactory.create('bookshelf',{id:'zone3.bookshelf1',label:'Zone 3 Bookshelf 2',breakRect:r(PX+PW-8,PY+20,6,17),blockRect:r(PX+PW-8,PY+20,6,17),render:{sprite:'bookshelf',x:PX+PW-8,y:PY+20,variant:1,layer:'main',overlayRect:r(PX+PW-8,PY+20,6,11)},broken:{sprite:'rubble',x:PX+PW-5,y:PY+37,variant:1}}),
