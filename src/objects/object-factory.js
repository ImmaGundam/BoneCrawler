// object-factory
// Purpose: game-object storage registry and handler
(function(){
  if(window.BoneCrawlerObjects) return;
  ...
  function spawnEnemy(def, payload){
  ...
  window.BoneCrawlerObjects = {spawn, spawnItem, spawnKey, spawnBoss, spawnEnemy, spawnNpc};
})();
