...
(function(){
  ...
  GameContent.registerEventBundle({
    transitionRules:[
      ...
      {id:'zone2_zone3', fromZone:2, nextZone:3, objectId:'zone2.door', transitionOpts:{fromZone:2}, requires:{all:[{type:'zone',equals:2},{type:'playerFlag',name:'zone2Key',equals:true},{type:'nearObject',objectId:'zone2.door',pad:4}]}} ,
      ...
      {id:'zone3_secret2', fromZone:3, nextZone:102, objectId:'zone3.secret2Portal', transitionOpts:{fromZone:3,resumePlay:true}, requires:{all:[{type:'zone',equals:3},{type:'globalFlag',name:'shadowBossDefeated',equals:true},{type:'globalAtLeast',name:'score',value:999},{type:'nearObject',objectId:'zone3.secret2Portal',pad:4}]}} ,
